...
import (
	...
	appv1alpha1 "github.com/Gliulei/redis-operator-test/pkg/apis/app/v1alpha1"
...
func add(mgr manager.Manager, r reconcile.Reconciler) error {
	...
	err = c.Watch(&source.Kind{Type: &appv1alpha1.RedisService{}}, &handler.EnqueueRequestForObject{})
	if err != nil {
		return err
	}
	...
	err = c.Watch(&source.Kind{Type: &corev1.Pod{}}, &handler.EnqueueRequestForOwner{
		IsController: true,
		OwnerType:    &appv1alpha1.RedisService{},
	})
	if err != nil {
		return err
	}
...
func (r *ReconcileRedisService) Reconcile(request reconcile.Request) (reconcile.Result, error) {
	...
	instance := &appv1alpha1.RedisService{}
...
func newPodForCR(cr *appv1alpha1.RedisService) *corev1.Pod {
